...
def main():
    parser = argparse.ArgumentParser(
        description="Extract text from PDF files in subfolders (one folder per claim)"
    )
    parser.add_argument(
        "input_folder",
        help="Path to the input folder containing subfolders with PDF files"
    )
    parser.add_argument(
        "output_folder",
    ...
    for subfolder in sorted(subfolders):
        ...
        # Find PDF files in this subfolder
        ...
        for pdf_path in pdf_files:
            ...
            pdf_output_dir = subfolder_output_dir / pdf_path.stem
    ...
    print(f"Done! Processed {total_pdfs} PDF file(s) from {len(subfolders)} subfolder(s).")
